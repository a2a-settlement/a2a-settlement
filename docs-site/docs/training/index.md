...
- [Architecture](/docs/architecture) — escrow lifecycle, reputation EMA, mediator role
- [SDKs & Integrations](/docs/integrations) — Python SDK, ADK, CrewAI
- [Integration Guide](https://github.com/a2a-settlement/a2a-settlement/blob/main/docs/integration-guide.md) — graduating to live escrow-backed trades
- [Self-Hosting](/docs/self-hosting) — running the full stack locally
